   ...
   and some other features helpful for model training and evaluation.
    ...
    def _train_epoch(self, train_data, epoch_idx, loss_func=None):
        ...
        for batch_idx, interaction in enumerate(train_data):
            ...
            losses = loss_func(interaction) # losses, mf_loss, vae_loss = loss_func(interaction) # 
    ...
    def _valid_epoch(self, valid_data):
        ...
        Returns:
            ...
            dict: valid result
        """
        valid_result, item_embedding = self.evaluate(valid_data)
        valid_score = valid_result[self.valid_metric] if self.valid_metric else valid_result['NDCG@20']
        return valid_score, valid_result, item_embedding
    ...
    def fit(self, train_data, valid_data=None, test_data=None, saved=False, save_dir=None, verbose=True):
        ...
        for epoch_idx in range(self.start_epoch, self.epochs):
            ...
            if (epoch_idx + 1) % self.eval_step == 0:
                ...
                _, test_result, item_embedding = self._valid_epoch(test_data)
                ...
                if update_flag:
                    ...
                    self.best_item_embedding = item_embedding
    ...
    def evaluate(self, eval_data, is_test=False, idx=0):
        ...
        for batch_idx, batched_data in enumerate(eval_data):
            ...
            scores, item_embedding = self.model.full_sort_predict(batched_data)
        ...
        return self.evaluator.evaluate(batch_matrix_list, eval_data, is_test=is_test, idx=idx), item_embedding
